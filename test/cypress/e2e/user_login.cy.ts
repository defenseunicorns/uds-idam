...
describe('User Login Tests', () => {
    ...
    it('Setup Testing Environment', () => {
        ...
        cy.fixture('properties.json').then((properties) => {
            ...
            cy.get('input[id="username"]').type(properties.admin.username)
            cy.get('input[id="username"]').should('have.value', properties.admin.username)

            // Enter Admin Password and Assert it was entered correctly
            cy.get('input[id="password"]').type(properties.admin.password)
            cy.get('input[id="password"]').should('have.value', properties.admin.password)
    ...
    it('User Login', () => {
        ...
        cy.fixture('properties.json').then((properties) => {
            ...
            cy.get('input[id="url"]').clear().type('https://'+properties.admin.hostname+'/auth')
            ...
            cy.url().should('include', 'https://'+properties.admin.hostname+'/auth&realm='+properties.realm+'&client='+properties.client+'')
            ...
            cy.origin('https://'+properties.admin.hostname, () => {
        ...
        cy.fixture('properties.json').then((properties) => {
            ...
            cy.origin('https://'+properties.admin.hostname, () => {
                ...
                cy.fixture('properties.json').then((properties) => {
                    ...
                    cy.get('div').contains(properties.realm).click()
                    ...
                    cy.get('div').contains(properties.realm).should('not.exist')
