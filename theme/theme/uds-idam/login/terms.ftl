        ...
        <div id="kc-terms-text" onclick="javscript:document.getElementById('kc-accept').focus()">
            <div>
                ...
                <ul>
                    ...
                    <li>NOTICE: There is the potential that information presented and exported from the Mission Environment
                        contains FOUO or Controlled Unclassified Information (CUI). It is the responsibility of all
                        users to ensure information extracted from the Mission Environment is appropriately marked and properly
                    ...
                    <li>As a user of this IS, you may have access to USG’s Mission Environment. Third-party software publishers
                        ...
                        Third Party Software available to users of Mission Environment. In the event you use the IS
                        (including the Mission Environment) to access, download, execute, display and/or otherwise use (collectively, “Use”)
                        such Third-Party Software, by Using the IS (including the Mission Environment) and/or such Third-Party Software,
